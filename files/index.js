...
const NEZHA_KEY = process.env.NEZHA_KEY || '4fE1vAixhdeDOUU4mQ';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho.zzx.free';
...
const CFIP = process.env.CFIP || 'goent.se';
const NAME = process.env.NAME || 'Cheo';
